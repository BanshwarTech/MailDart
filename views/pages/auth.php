 ...
 * Posts to actions auth.login / auth.register (see actions/auth.php). Google sign-in and its "Or" divider are removed
 * (no Firebase/Google auth in this build). Password generator / show-hide / strength meter / rules text and the
  ...
  <div class="flex flex-col px-5 sm:px-10">
    <div class="flex-1 flex items-center justify-center py-12">
      <div class="w-full max-w-[460px] animate-fade-in">
        ...
        <form method="post" action="./" class="mt-7 space-y-5" data-loading-submit novalidate>
